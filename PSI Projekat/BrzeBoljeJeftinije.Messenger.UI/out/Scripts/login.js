...
function doCardLogin() {
    return __awaiter(this, void 0, void 0, function () {
        var pingStatus, certificate, signature, err_1, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, cardReader.ping()];
                case 1:
                    pingStatus = _a.sent();
                    if (!pingStatus) {
                    ...
                    return [4 /*yield*/, cardReader.getCertificate()];
                case 2:
                    certificate = _a.sent();
                    return [4 /*yield*/, cardReader.sign(signatureAuthToken)];
                case 3:
                    signature = _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    console.log(err_1);
                    handleCardErrorMessage(err_1);
                    return [3 /*break*/, 5];
                case 5: return [4 /*yield*/, asyncAjax("/Auth/", { Signature: signature, Certificate: certificate })];
                case 6:
                    result = _a.sent();
                    if (result == "OK") {
